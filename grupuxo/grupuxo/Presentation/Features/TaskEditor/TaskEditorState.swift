...
struct TaskDraft: Equatable {
    ...
    // Identifica se esta tarefa foi criada a partir
    // de uma sugestão pré-configurada.
    var sourceSuggestionID: String?

    var kind = TaskKind.recurring
    var visibility = TaskVisibility.house
    var recurrence = RecurrencePolicy.recurring(
        frequency: .weekly,
        interval: 1
    )
    ...
    var draft: TaskDraft {
        ...
        case let .saved(definition):
            ...
            return TaskDraft(
                ...
                sourceSuggestionID: definition.sourceSuggestionID,
